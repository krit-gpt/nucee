...
<body id="top">
        ...
        <nav class="header-nav">
            ...
            <div class="header-nav__content">
                ...
                <ul class="header-nav__list">
                    ...
                    <li><a class="smoothscroll"  href="#visualization" title="works">Visualization</a></li>
    ...
    <!-- home
    ================================================== -->
    <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="images/backk.gif" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <div class="home-content">
            ...
            <div class="row home-content__main">
                ...
                <h1>Welcome to Nuce</h1>

                <h3>
                    Graph based Text Summarization<br>
    ...
    <section id='about' class="s-about">
        ...
        <div class="row section-header has-bottom-sep" data-aos="fade-up">
            <div class="col-full">
                ...
                <h1 class="display-1 display-1--light">We Are Team Nuce</h1>
            </div>
        ...
        <div class="row about-desc" data-aos="fade-up">
            <div class="col-full">
                <p>
                This is a project on Text Summarization using a graph based approach - TextRank and subsequent modifications.
                </p>
            </div>
        </div> <!-- end about-desc -->
    ...
    <section id='services' class="s-services">
        ...
        <div class="row section-header has-bottom-sep" data-aos="fade-up">
            <div class="col-full">
                ...
                <h1 class="display-2">We took the basic TextRank Algorithm and modified it </h1>
            </div>
        </div> <!-- end section-header -->
        ...
        <div class="row services-list block-1-2 block-tab-full">
            ...
            <div class="col-block service-item" data-aos="fade-up">
                ...
                <div class="service-text">
                    <h3 class="h2">Word Embeddings</h3>
                    <p>We applied word embeddings trained on Google News, to test and modify the TextRank Algorithm.
                    </p>
                </div>
            </div>
...
<!-- 
     ...
     Visualizations
    ================================================== -->
    <section id="visualization" style="background: #32373a">
        ...
        <div class="row section-header">
            <div class="col-full">
                ...
                <br>
                <button onclick = "updateload()"> See Visualization</button>
                <br>   <!-- class="col-xs-3" -->
                <div id="chartContainer" style="height: 300px; width: 47%; float: left" ></div>
                <div id="chartContainer2" style="height: 300px; width: 47%; float: right"  ></div>
                <br>
                <br>
                <br>
                <div></div>
...
<!--  Visualizations
    ================================================== --> 
    <section id="summary" style="background: white">
<div class="row section-header">
            <div class="col-full">
                <br>
                <h1 class="subhead">Summarizations</h1>
        <style>
        ...
        <textarea class="form-control" id="exampleFormControlTextarea4" rows="3" style="width: 1000px;"></textarea>
        <input type="submit" name="submit2" value="Summarize">
        </form>
    ...
    <section id="clients" class="s-clients">
        ...
        <div class="row section-header" data-aos="fade-up">
            <div class="col-full">
                <h3 class="subhead">Clients</h3>
                <h1 class="display-2">Nuce has been honored to
